...
public class ViewSolicitud extends javax.swing.JFrame implements Observer {
    ...
    private void agregarSolicitud() {
        ...
        if (verificarCamposCrearSolicitud() && nuevaSolicitud != null) {
    ...
    private void agregarBienASolicitud() {
        if (verificarCamposAgregarBien()) {
            if (nuevaSolicitud == null) {
                nuevaSolicitud = new Solicitud();

                try {
                    Double.parseDouble(campoPrecioUnitario.getText());
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(null, "Error en el precio unitario", "Error", JOptionPane.ERROR_MESSAGE);
                }
                nuevaSolicitud.agregarBien(new Bien(campoSerialBien.getText(), campoDescripcion.getText(),
                        campoMarca.getText(), campoModelo.getText(), Double.parseDouble(campoPrecioUnitario.getText()),
                        nuevaSolicitud, null));
            } else {
                try {
                    Double.parseDouble(campoPrecioUnitario.getText());
    ...
    private void initComponents() {
        ...
        campoSerialBien = new javax.swing.JTextField();
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(campoSerialBien, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jButton1.setText("Asignar registrador");
    ...
    private void btnAgregarBienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarBienActionPerformed
        // TODO add your handling code here:
        agregarBienASolicitud();
        if (nuevaSolicitud != null) {
            // ACTUALIZAR CANT BIENES Y MONTO TOTAL A SOLICITUD
            controller.setTable(nuevaSolicitud.getBienes());
            campoCantBienes.setText(Integer.toString(nuevaSolicitud.getCantidadBienes()));
            campoMontoTotal.setText(Double.toString(nuevaSolicitud.getMontoToTal()));
        }
    ...
    private void btnAgregarSolicitudActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarSolicitudActionPerformed
        //agrego lo bienes a la base
        agregarSolicitud();
 
        try {
            // devolver id de solicitud
            nuevaSolicitud.setNumSolicitud(controller.buscarSolicitud(nuevaSolicitud.getNumComprobante()).getNumSolicitud());
        } catch (Exception ex) {
            Logger.getLogger(ViewSolicitud.class.getName()).log(Level.SEVERE, null, ex);
        }

        if (nuevaSolicitud != null) {
            for (Bien b : nuevaSolicitud.getBienes()) {
                try {
                    controller.agregarBien(b);
                } catch (GlobalException | NoDataException ex) {
                    Logger.getLogger(ViewSolicitud.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTextField campoSerialBien;
